...
class TestCLI(unittest.TestCase):
    ...
    def test_cli(self):
        ...
        self.assertTrue(args.output == [''])
        args = cli.parser.parse_args(['explore','-v','-d','-o','test'])
        self.assertTrue(args.command == 'explore')
        self.assertTrue(args.log_level == 10)
        self.assertTrue(args.dark_mode == True)
        self.assertTrue(args.output == ['test'])
        ...
        self.assertTrue(args.dark_mode == True)
        self.assertTrue(args.output == [''])
        args = cli.parser.parse_args(['analyze','-v','-d','-o','test'])
        self.assertTrue(args.command == 'analyze')
        self.assertTrue(args.log_level == 10)
        self.assertTrue(args.dark_mode == True)
        self.assertTrue(args.output == ['test'])
        ...
        self.assertTrue(args.dark_mode == True)
        self.assertTrue(args.output == [''])
        args = cli.parser.parse_args(['deep','-v','-d','-o','test'])
        self.assertTrue(args.command == 'deep')
        self.assertTrue(args.log_level == 10)
        self.assertTrue(args.dark_mode == True)
        self.assertTrue(args.output == ['test'])
